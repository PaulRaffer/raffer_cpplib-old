...
[[nodiscard]] auto logical_not(auto x);
[[nodiscard]] auto logical_and(auto && ...x);
[[nodiscard]] auto logical_or(auto && ...x);
[[nodiscard]] auto logical_nand(auto && ...x);
[[nodiscard]] auto logical_nor(auto && ...x);
[[nodiscard]] auto logical_xor(auto && ...x);
[[nodiscard]] auto logical_xnor(auto && ...x);

[[nodiscard]] auto bit_not(auto x);
[[nodiscard]] auto bit_and(auto && ...x);
[[nodiscard]] auto bit_or(auto && ...x);
[[nodiscard]] auto bit_nand(auto && ...x);
[[nodiscard]] auto bit_nor(auto && ...x);
[[nodiscard]] auto bit_xor(auto && ...x);
[[nodiscard]] auto bit_xnor(auto && ...x);
